param(
    ...
    [string]$DatasourceUrl = "jdbc:mysql://host.docker.internal:3306/billing_app",
...
Set-GitHubSecret -Name "SPRING_DATASOURCE_URL" -Value $DatasourceUrl
Set-GitHubSecret -Name "SPRING_DATASOURCE_USERNAME" -Value $DatasourceUsername
